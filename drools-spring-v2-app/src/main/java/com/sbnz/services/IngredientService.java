...
import com.sbnz.interfaces.converters.IngredientConverterInterface;
import com.sbnz.interfaces.services.IngredientServiceInterface;
import com.sbnz.model.Ingredient;
import com.sbnz.repository.IngredientRepository;
/**
 * 
 * @author Nikola
 *
...
public class IngredientService implements IngredientServiceInterface {
	...
	public IngredientDTO Delete(long id) {
		Ingredient entity = repository.findOne(id);
		if (entity == null) {
